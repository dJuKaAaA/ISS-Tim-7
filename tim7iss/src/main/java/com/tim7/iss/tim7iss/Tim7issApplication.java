...
//            Ride ride5 = rideRepository.save(new Ride(null, 1000, LocalDateTime.now().plusMinutes(random.nextInt(2900, 4200)), null, route5.getEstimatedTimeInMinutes(), false, false, true, Enums.RideStatus.ACCEPTED, driver, driver.getVehicle().getVehicleType(), Set.of(passenger1, passenger3, passenger5), null, List.of(route5.clone())));
...
//>>>>>>> 50b34fdf552bfc00a228ba28027ca0cb7aa73ef2
        };
    }
}
